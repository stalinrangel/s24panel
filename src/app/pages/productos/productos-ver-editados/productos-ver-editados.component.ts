...
@Component({
  ...
  templateUrl: './productos-ver-editados.component.html',
  /*styles: [`
    nb-card {
      transform: translate3d(0, 0, 0);
    }
  `],*/
  styleUrls: ['./productos-ver-editados.component.scss'],
})
export class ProductosVerEditadosComponent implements OnInit{
