...
@Component({
  ...
  templateUrl: './mis-pagos-realizados.component.html',
  /*styles: [`
    nb-card {
      transform: translate3d(0, 0, 0);
    }
  `],*/
  styleUrls: ['./mis-pagos-realizados.component.scss'],
})
export class MisPagosRealizadosComponent implements OnInit{
